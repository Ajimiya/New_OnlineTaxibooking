    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create(Product product)
        {
            if (ModelState.IsValid)
            {
                ...
                product.Pro_Pic.SaveAs(Server.MapPath("~/OutPic/" + product.Pro_Pic.FileName));
                //product.Prod_Pic = "~/ProPic/" + product.Pro_Pic.FileName;
                if (product.Pro_Pic.FileName != "")
                {
                    product.Prod_Pic = "~/OutPic/" + product.Pro_Pic.FileName;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Prod_Id,Prod_Name,Prod_Disc,Price,Prod_Pic,Cat_Fid")] Product product)
        {
            if (ModelState.IsValid)
            {
